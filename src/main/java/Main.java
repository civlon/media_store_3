...
public class Main {
	...
	public static void main(String[] args) {
		...
		for (Iterator iterator = products6.iterator(); iterator.hasNext();) {
			...
			System.out.println("Künstler Name: " + artist.getArtistName());
			break;
		}
		...
		for (Iterator iterator = products9.iterator(); iterator.hasNext();) {
			...
			System.out.println("ÜberKategorie: " + category.getSuperCategory());
			break;
		}
		...
		for (Iterator iterator = products12.iterator(); iterator.hasNext();) {
			...
			System.out.println("Ort: " + branch.getCity());
			System.out.println("PLZ: " + branch.getZipCode());
		...
		for (Iterator iterator = products15.iterator(); iterator.hasNext();) {
			...
			System.out.println("Anzahl: " + purchase.getAmount());
			break;
		}
